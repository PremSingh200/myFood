...
const MenuCard = ({name,image,price,type,id}) => {
  ...
  return (
    <div className='h-[300px] w-[250px] p-5 shadow-lg rounded-md flex flex-col gap-3 hover:border-2 border-yellow-500 bg-white'>
        ...
        <button className='w-full  p-3 font-bold text-[15px] cursor-pointer bg-yellow-500 hover:bg-yellow-300 transition-all' onClick={()=>dispatch(AddItem({
